    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-px bg-border border border-border mb-8">
        ...
        <div className="bg-card p-6">
          ...
          <p className="text-sm text-foreground/80 mb-1">Москва, Нижняя Сыромятническая, 10, стр. 3</p>
          <p className="text-sm text-[#a3966f] font-medium mb-2">Вход 3В, этаж 2</p>
      ...
      {/* КАРТА */}
      <div className="mb-8">
        <div className="relative overflow-hidden border border-border rounded-xl" style={{ height: "420px" }}>
          <iframe
            title="ОМ Студия — Нижняя Сыромятническая, 10, стр. 3, вход 3В, этаж 2"
          ...
          <div className="absolute z-10 pointer-events-none" style={{ left: "50%", top: "50%", transform: "translate(22px, -58px)" }}>
            <div className="relative bg-white px-4 py-2.5 rounded-xl shadow-[0_4px_18px_rgba(0,0,0,0.22)] border border-[#e8e4da]">
              ...
              <div className="text-sm font-semibold text-[#222] whitespace-nowrap">Вход 3В, 2 этаж</div>
      ...
      <div className="flex items-start gap-3 mb-8">
        <div className="w-9 h-9 shrink-0 rounded-full bg-[#f6f3ee] flex items-center justify-center">
          <MapPin size={17} strokeWidth={1.5} className="text-[#a3966f]" />
        </div>
        <div>
          <div className="font-semibold text-sm mb-1">Наш адрес</div>
          <div className="text-sm text-foreground/70 leading-relaxed">
            Москва, Нижняя Сыромятническая, 10, стр. 3
            <br />
            <span className="text-[#a3966f] font-medium">Вход 3В, этаж 2</span>
          </div>
        </div>
      </div>
