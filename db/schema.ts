...
export const products = mysqlTable(
  "products",
  {
    ...
    design: varchar("design", { length: 50 }), // дизайн: Мрамор, Оникс, Бетон, Травертин, Дерево, Камень, Металл, Терраццо, Кирпич
    shape: varchar("shape", { length: 30 }), // форма: Квадрат, Прямоугольник, Шестигранник
